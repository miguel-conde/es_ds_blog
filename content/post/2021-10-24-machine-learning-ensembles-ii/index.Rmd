...
Como nos propusimos en el [artículo anterior](http://es100x100datascience.com/machine-learning-ensembles-i/), vamos a preparar un primer *ensemble* entrenando un `random forest`, un `svm` tipo *radial* y un `xgbm` tipo *tree* como modelos de primer nivel.
...
El código lo podéis encontrar en [github](https://github.com/miguel-conde/example_ensemble).
...
No vamos a repetir aquí la exploración de los datos que ya hemos hecho en los posts *Arboles de Decisión* [I](http://es100x100datascience.com/arboles-de-decision-i/), [II](http://es100x100datascience.com/arboles-de-decision-ii/), [III](http://es100x100datascience.com/arboles-de-decision-iii/) y [IV](http://es100x100datascience.com/arboles-de-decision-iv/), sino que vamos a ir directamente a la construcción del *ensemble*.
...
churn_valid <- churnTrain[-train_idx, c(target, predictoras)]
```
