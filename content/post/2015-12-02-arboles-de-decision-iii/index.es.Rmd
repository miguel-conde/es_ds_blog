...
```{r}
plot(rpart_churn_model, uniform = TRUE, branch = 0.6, margin = 0.01)
text(rpart_churn_model, all = TRUE, use.n = TRUE, cex = .7)
```
...
confusionMatrix(data = rpart_predictions, 
...
$$
Accuracy = \\frac{41+427}{41+25+7+427} = 0.936\
$$

El porcentaje de **falsos positivos** es:

$$
FP = \\frac{25}{41+25} = 0.3787879\
$$
